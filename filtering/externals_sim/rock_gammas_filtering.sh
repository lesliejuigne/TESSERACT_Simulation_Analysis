#!/bin/bash
#SBATCH --job-name=Rock_GammasFilter            # Job name
#SBATCH --output=Rock_GammasFilter_%A_%a.out    # Standard output log
#SBATCH --error=Rock_GammasFilter_%A_%a.err     # Error log
...
BASE_PATTERN="$INPUT_DIR/Rock_Gammas_${ISO}_*.root"
