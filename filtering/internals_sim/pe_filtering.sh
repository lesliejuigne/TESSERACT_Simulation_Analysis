#!/bin/bash
#SBATCH --job-name=PEFilter
#SBATCH --output=PEFilter_%A_%a.out
#SBATCH --error=PEFilter_%A_%a.err
...
#SBATCH --array=0-4   # 5 tasks: 0=Co60, 1=Cs137, 2=K40, 3=Th232, 4=U238


ISOTOPES=("Co60" "Cs137" "K40" "Th232" "U238")
...
BASE_PATTERN="$INPUT_DIR/PE_${ISO}_*.root"
